<?php
	...
	if (!isset($_SESSION['expense_add_good'])) {
		
		header('Location: index.php'); 
		exit(); 
	}else{
		unset($_SESSION['expense_add_good']);
	}
	//usuwanie zmiennych pamiętających wartości wpisane do formularza
	if (isset($_SESSION['form_expense_amount'])) unset($_SESSION['form_expense_amount']);
	if (isset($_SESSION['form_expense_date'])) unset($_SESSION['form_expense_date']);
	if (isset($_SESSION['form_expense_category'])) unset($_SESSION['form_expense_category']);
	if (isset($_SESSION['form_expense_payment'])) unset($_SESSION['form_expense_payment']);
	if (isset($_SESSION['form_expense_comment'])) unset($_SESSION['form_expense_comment']);
	
	//usuwanie błędów rejestracji
	if (isset($_SESSION['expense_error_amount'])) unset($_SESSION['expense_error_amount']);
	if (isset($_SESSION['expense_error_date'])) unset($_SESSION['expense_error_date']);
	if (isset($_SESSION['expense_error_category'])) unset($_SESSION['expense_error_category']);
	if (isset($_SESSION['expense_error_payment'])) unset($_SESSION['expense_error_paymen']);
	if (isset($_SESSION['expense_comment_error'])) unset($_SESSION['expense_comment_error']);
