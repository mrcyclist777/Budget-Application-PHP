<?php
	...
	if (!isset($_SESSION['income_add_good'])) {
		
		header('Location: index.php'); 
		exit(); 
	}else{
		unset($_SESSION['income_add_good']);
	}
	...
	if (isset($_SESSION['form_income_payment'])) unset($_SESSION['form_income_payment']);
	if (isset($_SESSION['form_income_comment'])) unset($_SESSION['form_income_comment']);
	
	//usuwanie błędów rejestracji
	if (isset($_SESSION['income_error_amount'])) unset($_SESSION['income_error_amount']);
	if (isset($_SESSION['income_error_date'])) unset($_SESSION['income_error_date']);
	if (isset($_SESSION['income_error_category'])) unset($_SESSION['income_error_category']);
	if (isset($_SESSION['income_error_payment'])) unset($_SESSION['income_error_paymen']);
	if (isset($_SESSION['income_comment_error'])) unset($_SESSION['income_comment_error']);
