            ...
            mysqli_real_escape_string($connection, $login))))
            {
                ...
                if($how_many_users > 0)
                {
                    ...
                    if(password_verify($password, $row['password']))
                    {
                        ...
                        $_SESSION['error'] = "Wrong login or password. Try again!";
                        header('Location: index.php');
                    }
                } else {
                    $_SESSION['error'] = "Wrong login or password. Try again!";
          ...
          <div class="py-5 p-4 my-4 text-center border border-dark rounded col-lg-8 mx-auto" id="heroes">
            ...
            <div class="col-lg-6 mx-auto">
                <form action="login.php" method="post">
                    ...
                    <div class="form-check text-start my-3 dark">
                      <input class="form-check-input" type="checkbox" value="remember-me" id="flexCheckDefault">
                      <label class="form-check-label" for="flexCheckDefault">
                        Remember me
                      </label>
                    </div>
                    <button type="button" class="btn btn-dark w-100 py-2 my-4" data-mdb-ripple-init>Login</button>
